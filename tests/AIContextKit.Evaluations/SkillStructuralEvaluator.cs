...
{
    public const string MetricName = "SkillStructuralScore"; // 0.0-1.0, represents 60 of 100 points
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // ---- Phase 1: Presence, Structure, Frontmatter (20 pts) ----
        double phase1 = ScorePhase1(content, findings);

        // ---- Phase 2: Field Constraints And Naming Parity (25 pts) ----
        ...
        // ---- Phase 4: Resource References And Safety (15 pts) ----
        double phase4 = ScorePhase4(content, findings);

        double totalPoints = phase1 + phase2 + phase4; // out of 60
        double normalized = totalPoints / 60.0;
